	...
	TableCellMouseListener, TableCellToolTipListener
{
	...
	public void cellPaint(GC gc, TableCellSWT cell) {
		...
		String info = MessageText.getString(key + ".info",
				"-----------------Need description TableColumn.header."
						+ column.getName() + ".info");
		...
		if (tv.isColumnAdded(column)) {
			...
			gc.setBackground(ColorCache.getColor(gc.getDevice(), 128, 128, 128));
			gc.fillRoundRectangle(x + 2, y + 2, w, h, 8, h);
			gc.setBackground(ColorCache.getColor(gc.getDevice(), 0, 0, 0));
	...
	public void cellHover(TableCell cell) {
		if (Constants.isCVSVersion()) {
			cell.setToolTip("" + cell.getDataSource());
		}
	}

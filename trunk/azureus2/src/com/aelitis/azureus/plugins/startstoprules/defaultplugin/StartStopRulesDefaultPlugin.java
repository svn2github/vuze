...
*/
  ...
  private class TotalsStats {
	...
	private void handleCompletedDownload(DefaultRankCalculator[] dlDataArray,
		...
		//	System.out.println("numWaitingOrSeeding " + vars.numWaitingOrSeeding
		//			+ " / " + "maxSeeders " + totals.maxSeeders + " / " + "maxActive "
		//			+ totals.maxActive);
		//}

...
public class AZHandshake implements AZMessage {
  ...
  public AZHandshake( int piece_number, int piece_offset, int length ) {
    ...
    buffer.putInt( bss, piece_number );
    buffer.putInt( bss, piece_offset );
    buffer.putInt( bss, length );
    buffer.flip( bss );
  }
  ...
  public Message deserialize( DirectByteBuffer data ) throws MessageException {   
    ...
    return new AZHandshake( num, offset, lngth );
  }

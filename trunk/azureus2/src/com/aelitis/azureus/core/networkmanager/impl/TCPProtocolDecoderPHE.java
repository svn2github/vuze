	...
	implements VirtualSelectorListener
{
		...
		throws IOException
	{
		try{
		    ...
		    SecretKeySpec	secret_key_spec_a = new SecretKeySpec( a_key, 0, RC4_STREAM_KEY_SIZE_BYTES, RC4_STREAM_ALG );
		        
		    SecretKeySpec	secret_key_spec_b = new SecretKeySpec( b_key, 0, RC4_STREAM_KEY_SIZE_BYTES, RC4_STREAM_ALG );

	...
	implements DHTTransportRequestHandler
{
	...
	{
		try{
			DHTTransport	udp1 = DHTTransportFactory.createUDP(6881, 5, 3, 5000, 50, 25, com.aelitis.azureus.core.dht.impl.Test.getLogger());
		
			udp1.setRequestHandler( this );
			
			DHTTransport	udp2 = DHTTransportFactory.createUDP(6882, 5, 3, 5000, 50, 25, com.aelitis.azureus.core.dht.impl.Test.getLogger());

...
public class FinishPanel extends AbstractWizardPanel {
  ...
  public void finish() {
    ...
    COConfigurationManager.setParameter("Max Upload Speed",cfWizard.maxUpSpeed * 8192);
    COConfigurationManager.setParameter("Max Upload",cfWizard.nbUploadsPerTorrent);

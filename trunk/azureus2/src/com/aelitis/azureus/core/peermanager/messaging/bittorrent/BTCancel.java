...
public class BTCancel implements BTProtocolMessage {
  ...
  public BTCancel( int piece_number, int piece_offset, int length ) {
    ...
    description = BTProtocolMessage.ID_BT_CANCEL + " piece #" + piece_number + ": " + piece_offset + "->" + (piece_offset + length -1);
  }
  
  
  public String getID() {  return BTProtocolMessage.ID_BT_CANCEL;  }

...
implements PEPeerTransport
{
  ...
  /**
   * This method is used to determine the client name to specify for non-Azureus
  ...
  protected void decodeAZHandshake( AZHandshake handshake ) {
	  ...
	  client = getExtendedClientName(this.client, handshake_client, handshake_client_version);

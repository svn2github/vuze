	...
	extends SWTSkinObjectBasic
{
	 ...
	 * 
	 */
	public SWTSkinObjectImage2(SWTSkin skin, SWTSkinProperties skinProperties,
			...
			public Object runSupport() {
				...
				if (sDrawMode == null) {
					sDrawMode = properties.getStringValue(
							SWTSkinObjectImage2.this.sConfigID + ".drawmode", "");
				}
				...
				//imgBounds = Utils.adjustPXForDPI(canvas.getDisplay(), imgBounds);

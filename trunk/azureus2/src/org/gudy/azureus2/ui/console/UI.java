...
import org.gudy.azureus2.ui.web.LocaleUtilServer;
...
public class UI implements ILocaleUtilChooser,IUserInterface {
  ...
  public void startUI() {
    ...
    System.out.println();
    console = new ConsoleInput(org.gudy.azureus2.ui.common.Main.GM, System.in, System.out);
  }

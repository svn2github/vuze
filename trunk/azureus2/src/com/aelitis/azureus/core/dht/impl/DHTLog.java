...
DHTLog 
{
		...
		DHTTransportValue	value )
	{
		if ( logging_on ){
			...
			return( getString( value.getValue()) + " <" + (value.isLocal()?"loc":"rem" ) + ",flag=" + Integer.toHexString(value.getFlags()) + ",life=" + value.getLifeTimeHours() + ",rep=" + value.getReplicationFactor() +",orig=" + value.getOriginator().getExternalAddress() +">" );
		}else{
			return( "" );
		}
	}

...
!define AZ_VERSION "2.3.0.4"        ;Define your own software version here
!define SWT_VERSION "3106"          ;SWT lib version
!define AZPLUGINS_VERSION "1.5"     ;azplugins plugin version
!define AZUPDATER_VERSION "1.6.3"   ;azupdater plugin version

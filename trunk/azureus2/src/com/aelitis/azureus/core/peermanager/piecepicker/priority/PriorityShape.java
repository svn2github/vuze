...
public interface PriorityShape
{
	...
	public static final int PRIORITY_MODE_FULL_PIECES	=0x00000004;	// requests will only be made of full pieces
	...
	public static final int PRIORITY_MODE_REVERSE_ORDER	=0x00000010;	// inverse ordering (ie end to front and/or rising ramp)

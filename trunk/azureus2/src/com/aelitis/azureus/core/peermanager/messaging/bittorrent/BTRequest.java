...
public class BTRequest implements BTProtocolMessage {
  ...
  public String getID() {  return BTProtocolMessage.ID_BT_REQUEST;  }
  
  public byte getVersion() {  return BTProtocolMessage.BT_DEFAULT_VERSION;  }
    
  public String getDescription() {
    return BTProtocolMessage.ID_BT_REQUEST + " piece #" + piece_number + ": " + piece_offset + "->" + (piece_offset + length -1);
  }
